...
export const PRODUCTS: Product[] = [
  {
    ...
    rating: 4.9,
    reviewsCount: 142,
    image: '/images/cat_antiparras.png',
  ...
  },
  {
    ...
    rating: 5.0,
    reviewsCount: 89,
    image: '/images/cat_mallas.png',
    secondaryImage: 'https://images.unsplash.com/photo-1519315901367-f34ff9154487?auto=format&fit=crop&w=800&q=80',
    isNew: false,
    isBestSeller: true,
    finaApproved: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 215,
    image: '/images/cat_gorros.png',
    secondaryImage: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=800&q=80',
    isNew: false,
    isBestSeller: true,
    finaApproved: true,
    hydrodynamicGrade: 'Pro Elite A+',
